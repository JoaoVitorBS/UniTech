...
from unitech.apps.base.views_mixins import SuperUserRequiredMixin

from .forms import UserLoginForm, UserRegistrationForm, PasswordResetForm, SetPasswordForm, PerfilUsuarioForm
from .models import Usuario
from unitech.configs.settings import DEFAULT_FROM_EMAIL
            ...
            if associated_user:
                try:
                    if associated_user.email:
                        ...
                        subject = u"Redefinir sua senha - UniTech"
